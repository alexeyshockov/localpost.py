"""LocalPost httptools backend, inline mode (no thread pool).

Bypasses the worker pool — every request runs on the selector thread.
Used to characterise selector-level throughput in isolation.
"""
