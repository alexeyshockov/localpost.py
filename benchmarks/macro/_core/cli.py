...
from benchmarks.macro._core.filters import select_stacks
from benchmarks.macro._core.pythons import PYTHONS
from benchmarks.macro._core.render import render_html, render_markdown
from benchmarks.macro._core.runner import pick_port, probe_python, run_cell
from benchmarks.macro._core.types import Cell, RunReport, Scenario, Stack
...
def run(
    *,
    ...
    p.add_argument(
        ...
        "'3.13=.venv-bench/3.13/bin/python' (default: every entry in benchmarks.macro._core.pythons.PYTHONS)",
    )
