...
[`benchmarks/macro/openapi/`](../openapi/README.md) measures **framework**
...
Output lands in `benchmarks/macro/http/results/<UTC-timestamp>/<python-label>/`:
...
([`benchmarks/macro/_core/cli.py`](../_core/cli.py)) does:

1. `subprocess.Popen` the stack as `python -m benchmarks.macro.http.apps.<stack>`.
