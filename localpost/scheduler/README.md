...
See [`examples/scheduler/`](../../examples/scheduler/) for more
(`cancellation.py`, `failing_tasks.py`, `fastapi_lifespan.py`, `finite_task.py`,
`serve_sync.py`, `fastdepends.py`).
...
- Cron source: [`cond/cron.py`](cond/cron.py)
- Built-in triggers: [`_cond.py`](_cond.py)
- Core: [`_scheduler.py`](_scheduler.py)
